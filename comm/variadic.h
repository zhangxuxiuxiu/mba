...
namespace comm
{
	namespace detail
	{
		...
		class variadic_np : public variadic_np<Hook, Types...>
		{
			public:
				template<class... Args>
				void operator()( Args&&... args)
				{
					variadic_np<Hook, Types...>::operator()(std::forward<Args>(args)... );	
					Hook<T>()( std::forward<Args>(args)... );
				}
		};
		
		template<template<class >class Hook,class T>
		class variadic_np<Hook, T>
		{
			public:
				template<class... Args>
				void operator()( Args&&... args)
